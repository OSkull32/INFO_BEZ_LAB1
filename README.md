...
### Описание проекта
разработки безопасного backend-приложения с
автоматизированной проверкой кода на уязвимости с аутентификацией JWT и интеграцией security-сканирования в CI/CD pipeline.
